        ...
        <div className="space-y-12">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-white/75">
                  We use Google Analytics to collect aggregated information
                  about how visitors interact with our website. This may include
                  pages visited, approximate location, browser type, device
                  type, referral source, session duration, and other usage
                  metrics.
                </p>

                <div className="grid md:grid-cols-2 gap-4">
                  <Glass variant="white" solidMobile className="p-5 rounded-xl">
                    <h3 className="font-semibold text-white mb-2">
                      Why We Use It
                    </h3>
                    <p className="text-white/60 text-sm">
                      To understand website performance, improve content,
                      measure marketing effectiveness, and identify technical
                      issues.
                    </p>
                  </Glass>
                  <Glass variant="white" solidMobile className="p-5 rounded-xl">
          ...
          >
            ...
            >
              ...
              <p className="text-white/70 mb-6">
                ...
                your cookie preferences. CookieYes may store your consent
                choices so that we can respect your selected preferences when
                you revisit our website.
              </p>
          ...
          >
            ...
            >
              ...
              <p className="text-white/70 mb-6">
                You have control over how cookies are used. Blocking some
                cookies may affect website functionality, but analytics and
                other non-essential cookies can generally be managed through
                consent tools or browser settings.
              </p>
          ...
          >
            ...
            >
              ...
              <p className="text-white/70 mb-8 max-w-2xl mx-auto">
                If you have questions about this Cookie Policy, Google
                Analytics, CookieYes, or how we use tracking technologies,
                please contact us.
              </p>
