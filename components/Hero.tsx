        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.div variants={itemVariants} className="py-10">
              <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full border border-white/10 bg-[#07111f]/90 md:bg-white/5 hover:border-[#00a8ff]/30 transition-all duration-300">
                <motion.div
            ...
            >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="group px-10 py-5 text-white font-medium text-lg rounded-2xl border border-white/20 hover:border-[#00a8ff]/50 bg-black/80 md:bg-transparent relative overflow-hidden"
              >
            ...
            >
              <div className="flex items-center gap-3">
                <div className="flex -space-x-2">
                  ...
                  <div className="w-8 h-8 rounded-full border-2 border-black bg-[#07111f]/90 md:bg-white/10 flex items-center justify-center text-xs text-white">
                    +02
                  </div>
                </div>
                  ...
                  <div className="flex flex-wrap justify-center gap-2">
                    {[
                      ...
                      <motion.span
                        ...
                        className="px-4 py-2 text-xs font-medium text-white/90 rounded-full border border-white/10 hover:border-[#00a8ff]/50 hover:text-[#00a8ff] transition-all duration-300 cursor-default"
                        style={{
                          background:
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="p-4 rounded-2xl border border-white/10 hover:border-[#00a8ff]/30 bg-[#07111f]/90 md:bg-transparent text-center group transition-all duration-300"
                  style={{
